	...
	-w*)
		case $2 in
			...
			*)
				...
				vers -w curl; vers -w git; vers -w gpg; vers -w heroku; vers -w imagemagick; vers -w mysql; vers -w python; vers -w rails; vers -w rbenv; vers -w rsync; vers -w ruby; vers -w wget
